      ...
      <div className="flex border-b">
        {tabs.map(t => (
          <button
            ...
            className={`px-4 py-2 text-sm font-medium border-b-2 ${tab === t.key ? 'border-blue-600 text-brand' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
          >
            {t.label}
          </button>
        ))}
          ...
          {bsLoading ? <p className="text-gray-500">Loading...</p> : !bs ? <p className="text-gray-400">No data</p> : (
            <div className="grid grid-cols-2 gap-8">
              ...
              <div>
                ...
                <h4 className="font-semibold text-brand mb-2 mt-4">Equity</h4>
                <table className="w-full text-sm">
                  <tbody>
