...
-- CreateIndex
CREATE INDEX "payroll_lines_payroll_batch_id_idx" ON "payroll_lines"("payroll_batch_id");

-- CreateIndex
CREATE INDEX "payroll_lines_employee_id_idx" ON "payroll_lines"("employee_id");

-- CreateIndex
CREATE INDEX "payroll_lines_technician_id_idx" ON "payroll_lines"("technician_id");

-- CreateIndex
CREATE INDEX "payroll_lines_earning_code_idx" ON "payroll_lines"("earning_code");

-- CreateIndex
CREATE INDEX "payroll_lines_department_code_idx" ON "payroll_lines"("department_code");
...
-- CreateIndex
CREATE INDEX "revenue_contracts_tenant_id_idx" ON "revenue_contracts"("tenant_id");

-- CreateIndex
CREATE INDEX "revenue_schedule_lines_contract_id_idx" ON "revenue_schedule_lines"("contract_id");
...
-- CreateTable
CREATE TABLE "dealer_group_tenants" (
    "id" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "dealer_group_tenants_dealer_group_id_idx" ON "dealer_group_tenants"("dealer_group_id");

-- CreateIndex
CREATE UNIQUE INDEX "dealer_group_tenants_dealer_group_id_tenant_id_key" ON "dealer_group_tenants"("dealer_group_id", "tenant_id");
...
-- CreateIndex
CREATE INDEX "webhook_registrations_is_active_idx" ON "webhook_registrations"("is_active");

-- CreateIndex
CREATE INDEX "webhook_deliveries_webhook_registration_id_idx" ON "webhook_deliveries"("webhook_registration_id");
...
-- CreateIndex
CREATE INDEX "documents_vendor_name_idx" ON "documents"("vendor_name");
...
-- CreateIndex
CREATE UNIQUE INDEX "user_preferences_tenant_id_user_id_key" ON "user_preferences"("tenant_id", "user_id");
...
-- CreateIndex
CREATE INDEX "data_quality_reports_tenant_id_period_idx" ON "data_quality_reports"("tenant_id", "period");
...
-- CreateIndex
CREATE INDEX "esg_metrics_tenant_id_period_idx" ON "esg_metrics"("tenant_id", "period");

-- CreateIndex
CREATE INDEX "esg_reports_tenant_id_period_idx" ON "esg_reports"("tenant_id", "period");



-- ====== analytics-service ======
-- CreateTable
CREATE TABLE "agg_monthly_pl" (
    "id" TEXT NOT NULL,
    "tenant_id" TEXT NOT NULL,
    "period" TEXT NOT NULL,
    "department_code" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "agg_tech_productivity" (
    "id" TEXT NOT NULL,
    "tenant_id" TEXT NOT NULL,
    "period" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "agg_monthly_pl_tenant_id_period_department_code_key" ON "agg_monthly_pl"("tenant_id", "period", "department_code");

-- CreateIndex
CREATE UNIQUE INDEX "agg_tech_productivity_tenant_id_period_technician_id_key" ON "agg_tech_productivity"("tenant_id", "period", "technician_id");

-- CreateIndex
CREATE UNIQUE INDEX "agg_parts_margin_tenant_id_period_part_number_key" ON "agg_parts_margin"("tenant_id", "period", "part_number");
...
-- CreateIndex
CREATE INDEX "ml_models_tenant_id_model_type_idx" ON "ml_models"("tenant_id", "model_type");

-- CreateIndex
CREATE INDEX "ml_predictions_tenant_id_idx" ON "ml_predictions"("tenant_id");

-- CreateIndex
CREATE INDEX "ml_predictions_model_id_idx" ON "ml_predictions"("model_id");
...
-- CreateIndex
CREATE INDEX "saved_queries_tenant_id_user_id_idx" ON "saved_queries"("tenant_id", "user_id");

-- CreateIndex
CREATE INDEX "query_history_tenant_id_user_id_idx" ON "query_history"("tenant_id", "user_id");
...
-- CreateIndex
CREATE INDEX "OrchestrationTask_tenantId_workflowType_idx" ON "OrchestrationTask"("tenantId", "workflowType");

-- CreateIndex
CREATE INDEX "OrchestrationTask_status_idx" ON "OrchestrationTask"("status");
