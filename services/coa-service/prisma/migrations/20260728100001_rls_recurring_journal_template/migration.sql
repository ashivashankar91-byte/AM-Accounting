-- S032 — extend the coa-service RLS baseline (see
-- 20260726000002_add_rls_policies / 20260728000003_add_rls_saved_gl_search)
-- to the 3 new S032 tables. Same 4-policy tenant-isolation pattern, FORCE ROW
-- LEVEL SECURITY, grant to amacc_rls_bypass.

DO $$
DECLARE
  t TEXT;
  tables TEXT[] := ARRAY[
    'recurring_journal_template', 'recurring_journal_template_line',
