...
// Copied verbatim (pattern + doc comment) from
// services/tenant-service/tests/support/fake-authz-client.ts — an in-memory
// stand-in for the real S207 AuthzService so route-level authorization
// tests don't need a live auth-service over HTTP. Deny-by-default: no
// matching assignment, or a matching role with no grant for the
// permission, both deny.
