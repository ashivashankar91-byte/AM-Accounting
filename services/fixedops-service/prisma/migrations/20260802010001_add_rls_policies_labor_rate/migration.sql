-- CE-11 S063 gap-closure — RLS for the two new tenant-owned tables, exact
-- same 4-policy pattern as 20260801040001_add_rls_policies_fixedops_svc.
