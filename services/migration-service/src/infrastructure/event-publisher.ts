...
/**
 * Topic-exchange publisher with an in-memory fallback so migration-service
 * runs in dev without a broker. Durability for migration.* domain events is
 * provided by the migration_outbox table written inside the service
