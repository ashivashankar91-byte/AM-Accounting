-- CE-09 S050: Row Level Security for the AR write-off/allowance tables,
-- following the exact pattern shipped for S036A/S038/S039/S041/S043A/S042/S045/S048.

DO $$
DECLARE
  t TEXT;
  tables TEXT[] := ARRAY[
    'ar_direct_write_offs', 'ar_write_off_threshold_configs', 'ar_write_off_gl_account_configs',
    'ar_allowance_band_configs', 'ar_allowance_previews', 'ar_allowance_gl_account_configs'
  ];
BEGIN
