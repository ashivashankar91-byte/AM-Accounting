-- CE-09 S051: Row Level Security for the NSF tables, following the exact
-- pattern shipped for S036A/S038/S039/S041/S043A/S042/S045/S048/S050.

DO $$
DECLARE
  t TEXT;
  tables TEXT[] := ARRAY[
    'ar_nsf_events', 'ar_nsf_fee_configs', 'ar_nsf_hold_configs', 'ar_nsf_gl_account_configs'
  ];
BEGIN
