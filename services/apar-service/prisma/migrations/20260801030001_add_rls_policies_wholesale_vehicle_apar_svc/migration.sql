-- CE-09 S048: Row Level Security for the wholesale vehicle title-gate
-- tables, following the exact pattern shipped for S036A/S038/S039/S041/
-- S043A/S042/S045.
...
DECLARE
  t TEXT;
  tables TEXT[] := ARRAY[
    'ar_wholesale_vehicle_items', 'ar_title_release_exceptions'
  ];
BEGIN
