-- CE-09 S043B: Row Level Security for the payment-run tables, following
-- the exact pattern shipped for S036A/S038/S039/S041/S043A/S042/S045/
-- S048/S050/S051.
...
DECLARE
  t TEXT;
  tables TEXT[] := ARRAY[
    'ap_payment_runs', 'ap_payment_run_items', 'ap_payment_run_rail_artifacts'
  ];
BEGIN
