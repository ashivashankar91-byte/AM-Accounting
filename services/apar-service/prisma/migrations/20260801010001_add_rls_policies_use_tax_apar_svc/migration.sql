-- CE-09 S042: Row Level Security for the use-tax self-assessment tables,
-- following the exact pattern shipped for S036A/S038/S039/S041/S043A (see
...
DECLARE
  t TEXT;
  tables TEXT[] := ARRAY[
    'ap_use_tax_gl_account_configs', 'ap_use_tax_rate_configs', 'ap_use_tax_assessments'
  ];
BEGIN
