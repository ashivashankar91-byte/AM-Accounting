-- CE-09 S047: Row Level Security for the fleet-billing tables, following
...
DECLARE
  t TEXT;
  tables TEXT[] := ARRAY[
    'ar_fleet_unit_links', 'ar_consolidated_invoices', 'ar_consolidated_invoice_items', 'ar_fleet_billing_gl_account_configs'
  ];
BEGIN
