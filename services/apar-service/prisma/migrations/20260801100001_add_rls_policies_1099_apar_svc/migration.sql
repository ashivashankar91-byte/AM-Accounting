-- CE-09 S037: Row Level Security for the 1099/T4A tables, following the
-- exact pattern shipped for every prior CE-09 story.

DO $$
DECLARE
  t TEXT;
  tables TEXT[] := ARRAY[
    'ap_1099_vendor_box_rules', 'ap_1099_threshold_configs', 'ap_1099_corrections'
  ];
BEGIN
