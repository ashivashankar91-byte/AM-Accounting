-- CE-09 S049: Row Level Security for the insurance-AR tables, following
-- the exact pattern shipped for every prior CE-09 story.

DO $$
DECLARE
  t TEXT;
  tables TEXT[] := ARRAY[
    'ar_insurance_claims', 'ar_insurance_claim_supplements', 'ar_insurance_payment_applications', 'ar_insurance_short_pay_dispositions', 'ar_insurance_gl_account_configs'
  ];
BEGIN
